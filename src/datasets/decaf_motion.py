...
def make_decaf_motion_dataset(args, is_train=True, cams=None):
    ...
    dataset = DecafMotionDataset(base_path=dataset_path,
                                mode=mode,
...
class DecafMotionDataset(torch.utils.data.Dataset):
    def __init__(self,
                 base_path,
                 cam_space_deform,
                 load_dict,
