...
class DeformLoaderOffLine(torch.utils.data.Dataset):
    def __init__(self,
                 base_path,
                 cam_space_deform,
                 load_dict,
...
#                   "bb_hand_base_path": bb_hand_base_path,
    ...
    def __getitem__(self, idx):
        ...
        if self.mode == "test" and self.train_img_rotate_aug and random.uniform(0, 1) <= self.rot_prob:
        ...
        single_img_seqs = tmp_all_imgs[single_image_idx]
        ...
        return_dict["single_img_seqs"] = single_img_seqs.squeeze()
        ...
        return_dict["head_vs_in_cam_deformed"] = head_vs_in_cam_deformed
        ...
        return_dict["head_vs_in_cam"] = head_vs_in_cam
        # return_dict["head_vs_in_cam_f"] = head_vs_in_cam_f
        return_dict["rh_vs_in_cam"] = rh_vs_in_cam
        # return_dict["rh_vs_in_cam_f"] = rh_vs_in_cam_f
        return_dict["rh_keys_in_cam"] = rh_keys_in_cam
        return_dict["head_keys_in_cam"] = head_keys_in_cam
        ...
        return_dict["rh_con_labels"] = rh_con_labels
        # return_dict["lh_con_labels"] = lh_con_labels
        return_dict["head_con_labels"] = head_con_labels
        ...
        # return_dict["frame_id"] = random_frame_id
